					...
					<div class="announcement-container">
						...
						<div style="padding-top:10px;">
							...
							if (isset($_SESSION['user_type'])) {
								// User is logged in, display the join form
								?>
								<form action="volunteer.php" method="POST">
									<button type="submit" name="join_program" class="btn btn-primary btn-sm float-end" style="background-color: black;">Join Program</button>
									<!-- Include the program_id as a hidden input field -->
									<input type="hidden" name="program_id" value="<?= $program['id']; ?>">
									<!-- Add an optional phone number field -->
									<input type="text" name="phone_number" placeholder="Phone Number (Optional)">
								</form>
								<?php
							} else {
								// User is not logged in, display a warning message
								echo '<p style="color: red;">Sign Up/Log-in to Join a Program.</p>';
							}
							?>
						</div>
					</div>

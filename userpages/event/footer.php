            ...
            <div class="col-md-12">
                <ul style="list-style: none; padding: 0; margin: 0; display: inline-block;">
                    <li style="display: inline-block; margin: 0 10px;">
                        <a href="../../hpuser.php" style="color: white; text-decoration: none; font-size: 16px; font-style: italic;">Home</a>
                    </li>
                    <li style="display: inline-block; margin: 0 10px;">
                        <a href="userpages/announce/announcements.php" style="color: white; text-decoration: none; font-size: 16px; font-style: italic;">Announcement</a>
                    </li>
                    <li style="display: inline-block; margin: 0 10px;">
                    ...
                    <li style="display: inline-block; margin: 0 10px;">
                        <a href="../services/services.php" style="color: white; text-decoration: none; font-size: 16px; font-style: italic;">Services</a>
                    </li>
                </ul>

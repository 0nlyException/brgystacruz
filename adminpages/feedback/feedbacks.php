...
<body style = "font-family: 'Josefin Sans';">
	...
	<div class="content-container" style="margin-bottom:15%;border-radius:10px">
		<h1 id="about" style="text-align:center;color: black;font-weight: 700;padding-top:25px;">FEEDBACK</h1>
		<hr>
					...
					<div class="announcement-container">
						...
						<div>
							<form action="admin.php" method="POST" class="d-inline">
								<button type="submit" name="deletefeedback" value="<?= $admin['id']; ?>" class="btn btn-primary btn-sm" style="background-color: black;">DELETE</button>
							</form>
						</div>
					</div>
			<?php

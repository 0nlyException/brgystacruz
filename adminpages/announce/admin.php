...
if(isset($_POST['updateannouncements'])) {
    ...
    // File upload handling if image is set
    ...
    // Update announcement with or without image
    if(isset($image)) {
        $query = "UPDATE announcement SET title ='$title', description='$description', image='$image' WHERE id='$admin_id'";
    } else {
        $query = "UPDATE announcement SET title ='$title', description='$description' WHERE id='$admin_id'";
    }
...
if(isset($_POST['registerannouncements'])) {
    ...
    // Insert announcement with or without image
    if(isset($image)) {
        $query = "INSERT INTO announcement (title, description, image) VALUES ('$title', '$description', '$image')";
    } else {
        $query = "INSERT INTO announcement (title, description) VALUES ('$title', '$description')";
    }

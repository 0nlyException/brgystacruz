...
<body style = "font-family: 'Josefin Sans';">
	...
	<div class="content-container"  style="margin-bottom:15%;border-radius:10px">
		...
		<div class="buttons-container">
			<button class="add-button" ><a href="addannouncements.php" class="btn btn-primary btn-sm float-end"style="background-color: black;">ADD</a></button>
				...
				foreach ($query_run as $admin) {
					...
					<div class="announcement-container" >
						...
						<?php if (!empty($admin['image'])): ?>
							...
							<img src="data:image/jpeg;base64,<?= base64_encode($admin['image']); ?>" >
						<?php endif; ?>
						<div style = "padding-top: 10px;">
							<!-- Functioning edit and delete buttons -->
							<a href="editannouncements.php?id=<?= $admin['id']?>" class="btn btn-primary btn-sm" style="background-color: black;">EDIT</a>
							<form action="admin.php" method="POST" class="d-inline">
								<button type="submit" name="deleteannouncements" value="<?= $admin['id']; ?>" class="btn btn-primary btn-sm" style="background-color: black;">DELETE</button>
							</form>
						</div>
					</div>
			<?php

...
<body style = "font-family: 'Josefin Sans';">
	...
	<div class="content-container"  style="margin-bottom:15%;border-radius:10px">
		<h1 id="about" style="text-align:center;color: black;font-weight: 700;padding-top:25px;">PROGRAMS</h1>
		<hr>
		<div class="buttons-container">
			<button class="add-button"><a href="addprograms.php" class="btn btn-primary btn-sm float-end" style="background-color: black;">ADD</a></button>
			...
			<button class="back-button"><a href="participant.php" class="btn btn-primary btn-sm float-end"style="background-color: black;">VIEW</a></button>
		</div>
				...
				if(mysqli_num_rows($query_run) > 0) {
					foreach ($query_run as $program) {
						...
						<div class="announcement-container">
							<div>
								<h2 style="color: black;font-weight: 700"><?= $program['title']; ?></h2>
								<p style="color: black;font-weight: 600"><?= $program['description']; ?></p>
							</div>
							<img src="data:image/jpeg;base64,<?= base64_encode($program['image']); ?>" alt="<?= $program['title']; ?>">
							<div style = "padding-top: 10px;">
								<a href="editprograms.php?id=<?= $program['id']?>" class="btn btn-primary" style="background-color: black;">Edit</a>
								<form action="admin.php" method="POST" class="d-inline">
									<button type="submit" name="deleteprograms" value="<?= $program['id']; ?>" class="btn btn-primary" style="background-color: black;">Delete</button>
								</form>
							</div>
						</div>
				<?php

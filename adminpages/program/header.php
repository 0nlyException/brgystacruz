    ...
    <div class="container" style="margin-left: 20px; padding-top: 1%">
        ...
        <div class="collapse navbar-collapse" id="nav_mainmenu">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a href="../services/service_requests.php" class="nav-link" style="font-style: normal;font-weight:500; color: white; font-size: 16px; padding: 8px 12px; border-radius: 5px; margin-right: 5px; text-decoration: none;">Services</a>
                </li>
                <?php
                if (isset($_SESSION['user_id'])) {
                    ...
                    if ($result && mysqli_num_rows($result) > 0) {
                        ...
                        echo '<li class="nav-item" style = "padding-top: 1px"><a href="../../Login Page.php" class="nav-link"  style="font-style: normal; font-weight: 500;color: black; font-size: 16px; background-color: white; border: 1px solid #ccc; border-radius: 25px; padding: 5px 10px; margin-left: 5px; text-decoration: none; ">Register</a></li>';
                    }
                } else {

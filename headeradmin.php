    ...
    <div class="container" style="margin-left: 20px; padding-top: 1%">
        ...
        <div class="collapse navbar-collapse" id="nav_mainmenu">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a href="hpadmin.php" class="nav-link" style="font-style: normal;font-weight:500; color: white; font-size: 16px; padding: 8px 12px; border-radius: 5px; margin-right: 5px; text-decoration: none;">Home</a>
                </li>
                <li class="nav-item">
                    <a href="adminpages/announce/announcements.php" class="nav-link" style="font-style: normal;font-weight:500; color: white; font-size: 16px; padding: 8px 12px; border-radius: 5px; margin-right: 5px; text-decoration: none;">Announcement</a>
                </li>
                <li class="nav-item">
                    <a href="adminpages/program/program1.php" class="nav-link" style="font-style: normal;font-weight:500; color: white; font-size: 16px; padding: 8px 12px; border-radius: 5px; margin-right: 5px; text-decoration: none;">Programs</a>
                </li>
                <li class="nav-item">
                    <a href="adminpages/event/events.php" class="nav-link" style="font-style: normal;font-weight:500; color: white; font-size: 16px; padding: 8px 12px; border-radius: 5px; margin-right: 5px; text-decoration: none;">Event</a>
                </li>
                <li class="nav-item">
                    <a href="adminpages/feedback/feedbacks.php" class="nav-link" style="font-style: normal;font-weight:500; color: white; font-size: 16px; padding: 8px 12px; border-radius: 5px; margin-right: 5px; text-decoration: none;">Feedback</a>
                </li>
                <li class="nav-item">
                    <a href="adminpages/official/officials.php" class="nav-link" style="font-style: normal;font-weight:500; color: white; font-size: 16px; padding: 8px 12px; border-radius: 5px; margin-right: 5px; text-decoration: none;">Officials</a>
                </li>
                <li class="nav-item">
                    <a href="adminpages/about/abouts.php" class="nav-link" style="font-style: normal;font-weight:500; color: white; font-size: 16px; padding: 8px 12px; border-radius: 5px; margin-right: 5px; text-decoration: none;">About</a>
                </li>
                <li class="nav-item">
                    <a href="adminpages/services/service_requests.php" class="nav-link" style="font-style: normal;font-weight:500; color: white; font-size: 16px; padding: 8px 12px; border-radius: 5px; margin-right: 5px; text-decoration: none;">Services</a>
                </li>
                <?php
